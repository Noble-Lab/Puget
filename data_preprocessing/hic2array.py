...
if __name__ == '__main__':
    if len(sys.argv) != 6:
        print('Usage: python hic2array.py [input.hic] [output.pkl] [resolution] [normalization_type] [mode]')
        ...
        print("mode: 0 for scipy sparse matrix, 1 for numpy dense matrix, 2 for scipy sparce matrix (only cis-contact); 3 for numpy dense matrix (only cis-contact).")
        sys.exit(1)
